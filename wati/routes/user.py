...
async def new_user(
    ...
    try:
        ...
        if not result.get("success"):
            return JSONResponse(status_code=400, content={"success": False, "message": "CAPTCHA verification failed"})
        ...
        if existing_user:
            return JSONResponse(
                status_code=400,
                content={"success": False, "message": "Account with this email or phone number already exists"}
            )
